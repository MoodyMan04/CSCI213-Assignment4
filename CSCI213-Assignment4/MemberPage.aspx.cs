                ...
                try
                {
                    ...
                    var result = (from s in db.Sections
                                  join i in db.Instructors on s.Instructor_ID equals i.InstructorID
                                   ...
                                   select new { SectionName = s.SectionName, InstructorFirstName =
                                                i.InstructorFirstName, InstructorlastName = i.InstructorLastName,
                                                PaymentDate = s.SectionStartDate, Payment = s.SectionFee});
